...
SELECT stadium, head_couch FROM teams WHERE conference = 'NFC';

-- 3. List the head coaches of the AFC South

SELECT head_couch FROM teams WHERE conference = 'AFC' AND division = 'South';
...
SELECT name, head_couch FROM teams WHERE (conference = 'NFC' AND division = 'North') OR (conference = 'AFC' AND division = 'East');
...
SELECT name, position FROM players ORDER BY salary;
